...
const DEUDA_CONOCIDA = new Set([
  ...
  "scripts/forward-test.ts", "scripts/forward-ideas.ts", "scripts/forward-wheel.ts",
...
describe("ningún resultado sale de un modelo", () => {
  ...
  it("los tres forward-tests siguen parados mientras valoren con modelo", () => {
    for (const f of ["scripts/forward-test.ts", "scripts/forward-ideas.ts", "scripts/forward-wheel.ts"]) {
