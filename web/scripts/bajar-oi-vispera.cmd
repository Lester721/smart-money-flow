@echo off
REM ── LA DESCARGA DEL OI DE LA VISPERA, FUERA DE LA SESION DE CLAUDE ─────────────────────────
REM
...
set CERROJO=%RAIZ%\scripts\cache-theta\.oi-vispera-corriendo
set LOG=%RAIZ%\scripts\cache-theta\oi-vispera.log
cd /d "%RAIZ%"
...
node scripts\with-theta.mjs node scripts\bajar-oi-vispera.mjs >> "%LOG%" 2>&1
