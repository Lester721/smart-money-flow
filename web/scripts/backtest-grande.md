...
**Muestra:** tickers AAPL, MSFT, NVDA, AMZN, GOOGL, META, TSLA, AMD, NFLX, QQQ, SPY, HOOD · ventana 180 días · premium ≥ $1.0M · **203 flujos resueltos** (con tiempo suficiente para juzgar).

## Línea base
- Hit rate global: **51%** (203 flujos). Un 50% = moneda al aire.

## Por señal de sub-agente (hit rate por banda)

| Señal | Banda | Hit rate | n |
|---|---|---|---|
| **Agresividad** | Compra al ask | 54% | 105 |
| | Venta al bid | 47% | 98 |
| | Al medio (mid) | — | 0 |
| **Inusualidad** | Score ≥ 7 (institucional) | 41% | 41 |
| | Score < 7 | 53% | 162 |
| **Convicción (delta)** | \|delta\| ≥ 0.60 (direccional) | 45% | 49 |
| | \|delta\| < 0.60 | 53% | 154 |
| **Tamaño** | ≥ $5M | 57% | 23 |
| | < $5M | 50% | 180 |
