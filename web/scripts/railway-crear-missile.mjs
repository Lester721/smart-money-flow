// Crear el servicio de Railway para TSLA's Missile — copiando la configuración de un servicio
...
//
// Uso:
//   node --env-file=.env.local scripts/railway-crear-missile.mjs            (sólo mira)
//   node --env-file=.env.local scripts/railway-crear-missile.mjs --crear    (crea de verdad)
const TOKEN = process.env.RAILWAY_TOKEN;
const API = 'https://backboard.railway.com/graphql/v2';
const CREAR = process.argv.includes('--crear');
const NOMBRE = "TSLA's Missile";
const CONFIG = 'web/railway.missile.json';
const CRON = '30 23 * * 1-5';            // 23:30 UTC = 19:30 Nueva York, detrás de los demás
