// ══ LIB de r128 ══ el lector de cadenas y la operación de la vertical, extraídos SIN TOCAR
// NADA para que r129 mida con el mismo código y no se separen por copiar y pegar.
...
export function serieVertical(ancho, cruzar) {
  const O = [];
