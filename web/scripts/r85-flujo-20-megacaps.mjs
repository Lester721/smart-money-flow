// LOS 20 MEGACAPS — flujo 2021-2026. El universo REAL de la regla (2026-08-27).
// Los 20 anteriores eran nombres poco activos: 16 de 20 dieron 0 o 1 señal en seis años.
// Estos salen de la lista rankeada POR EL PROPIO FLUJO de bajar-cadenas-top-flujo.mjs,
// quitando ETFs, índices y los que no existían en 2021.
//
...
const TICKERS = ["GOOGL", "AMZN", "AVGO", "MU", "MRVL", "TSM", "PLTR", "ASML", "MSTR", "DELL",
                 "WDC", "AMAT", "STX", "GS", "NFLX", "COIN", "BABA", "SHOP", "UBER", "ARM"];
const MESES = [];
