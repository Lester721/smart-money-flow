...
const NUEVOS = ["GOOGL","AMZN","AVGO","MU","MRVL","TSM","PLTR","ASML","MSTR","DELL","WDC","AMAT","STX","GS","NFLX","COIN","BABA","SHOP","UBER","ARM"];
const VIEJOS_TODOS = ["AAPL","AMD","META","MSFT","NVDA","QQQ","SPY","TSLA","BA","JPM","INTC","F","BAC","DIS","XOM","GE","PYPL","COST","CRM","ORCL","WMT","T","PFE","KO","CSCO","NKE","UNH","WBA"];
const SOLO_CALLS = process.argv.includes("--calls");
const MAG = (f) => (!SOLO_CALLS || f.l === "C") && f.dentro && f.dte >= 5 && f.ask * 100 >= 10000 && f.hora >= "14:00" && f.vsOI >= 12;
...
const V = construir(VIEJOS_TODOS, TODO);
