...
for (const [nom, modo] of [["DESCANSANDO EN SPY", "spy"], ["LA ESTRATEGIA SOLA (efectivo 3,3%)", "efectivo"]]) {
  console.log("");
  console.log("  ══ AÑO POR AÑO — parando si SPY cae 10% · " + nom + " ══");
  console.log("");
  const q = cuenta2({ capital: 60000, umbral: 0.10, modo });
  ...
  for (const y of ["2016","2017","2018","2019","2020","2021","2022","2023","2024","2025","2026"]) {
    ...
    const r = cuenta2({ capital: 60000, umbral: 0.10, modo, hasta: fin });
