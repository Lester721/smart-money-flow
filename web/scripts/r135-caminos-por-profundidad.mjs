...
// UNA sola pasada por las cadenas guardando, para cada día y ticker, el camino diario de
// CUATRO profundidades y DOS plazos. Así el barrido posterior es instantáneo y no hay que
...
const PROFS = [0.15, 0.25, 0.35, 0.50];        // cuánto dentro del dinero
const DTES  = [120, 250];                       // plazo objetivo
